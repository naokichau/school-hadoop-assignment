...
public class BinFilesToHadoopSeqFile {
    ...
    private static Logger logger = Logger.getLogger(BinFilesToHadoopSeqFile.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length != 2) {
            System.err.println("Usage: BinFilesToHadoopSeqFile <in Path for url file> <out pat for sequence file>");
            System.exit(2);
        }
